...
# Define the LM, but don't configure it globally to prevent Streamlit thread-lock errors
...
with col2:
    ...
    # The input box automatically anchors to the bottom of the column
        ...
        with chat_container:
            ...
            with st.chat_message("assistant"):
                with st.spinner("Compiling SQL and analyzing physics..."):
                    ...
                    # Safely pass the LM into this specific thread's context
